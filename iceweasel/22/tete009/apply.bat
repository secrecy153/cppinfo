...
set BUILDDIR=F:\works\ff-release

REM Environment variables:
set TT_MOZ_SRC_DIR=%BUILDDIR%
set TT_PATCH_DIR=F:\works\v22\tete009
...
patch -N %TT_MOZ_SRC_DIR%\js\src\builtin\Eval.cpp %TT_PATCH_DIR%\Eval.cpp.patch
patch -N %TT_MOZ_SRC_DIR%\js\src\methodjit\PolyIC.cpp %TT_PATCH_DIR%\PolyIC.cpp.patch

REM avoid compile errors with VC8:
patch -N %TT_MOZ_SRC_DIR%\content\base\public\nsINode.h %TT_PATCH_DIR%\nsINode.h.patch
patch -N %TT_MOZ_SRC_DIR%\gfx\skia\src\gpu\gl\GrGpuGL.h %TT_PATCH_DIR%\GrGpuGL.h.patch
...
patch -N %TT_MOZ_SRC_DIR%\gfx\cairo\libpixman\src\pixman-implementation.c %TT_PATCH_DIR%\pixman-implementation.c.patch
...
patch -N %TT_MOZ_SRC_DIR%\gfx\harfbuzz\src\hb-open-type-private.hh %TT_PATCH_DIR%\hb-open-type-private.hh.patch
...
patch -N %TT_MOZ_SRC_DIR%\gfx\2d\SSEHelpers.h %TT_PATCH_DIR%\SSEHelpers.h.patch
...
patch -N %TT_MOZ_SRC_DIR%\layout\svg\Makefile.in %TT_PATCH_DIR%\svg_Makefile.in.patch
...
patch -N %TT_MOZ_SRC_DIR%\content\canvas\src\CanvasRenderingContext2D.cpp %TT_PATCH_DIR%\CanvasRenderingContext2D.cpp.patch
...
REM installer:
patch -N %TT_MOZ_SRC_DIR%\browser\installer\Makefile.in %TT_PATCH_DIR%\browser_installer_Makefile.in.patch
patch -N %TT_MOZ_SRC_DIR%\..\mail\installer\Makefile.in %TT_PATCH_DIR%\mail_installer_Makefile.in.patch
...
patch -N %TT_MOZ_SRC_DIR%\client.mk %TT_PATCH_DIR%\client.mk.patch
